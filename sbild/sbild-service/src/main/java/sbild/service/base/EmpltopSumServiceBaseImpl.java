...
import sbild.service.EmpltopSumService;
import sbild.service.EmpltopSumServiceUtil;
...
/**
 * Provides the base implementation for the empltop sum remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link sbild.service.impl.EmpltopSumServiceImpl}.
 * </p>
 *
 * @author liferay
 * @see sbild.service.impl.EmpltopSumServiceImpl
 * @generated
 */
public abstract class EmpltopSumServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EmpltopSumService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmpltopSumService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EmpltopSumServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EmpltopSumService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		empltopSumService = (EmpltopSumService)aopProxy;

		_setServiceUtilService(empltopSumService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmpltopSumService.class.getName();
	}
	...
	private void _setServiceUtilService(EmpltopSumService empltopSumService) {
		try {
			Field field = EmpltopSumServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, empltopSumService);
		}
	...
	@Reference
	protected sbild.service.EmpltopSumLocalService empltopSumLocalService;

	protected EmpltopSumService empltopSumService;
