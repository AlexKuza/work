...
import sbild.model.ElectroEmployeeTable;
import sbild.model.impl.ElectroEmployeeImpl;
import sbild.model.impl.ElectroEmployeeModelImpl;
 ...
 * @generated
 */
@Component(service = {ElectroEmployeePersistence.class, BasePersistence.class})
public class ElectroEmployeePersistenceImpl
	...
	public ElectroEmployeePersistenceImpl() {
		...
		setTable(ElectroEmployeeTable.INSTANCE);
	}
	...
	public void clearCache() {
		...
		finderCache.clearCache(ElectroEmployeeImpl.class);
	}
	...
	private static class ElectroEmployeeModelArgumentsResolver
		...
		public String getClassName() {
			return ElectroEmployeeImpl.class.getName();
		}

		@Override
		public String getTableName() {
			return ElectroEmployeeTable.INSTANCE.getTableName();
		}
