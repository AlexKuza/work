...
import sbild.exception.NoSuchElectroTypeException;

import sbild.model.ElectroType;
import sbild.model.ElectroTypeTable;
import sbild.model.impl.ElectroTypeImpl;
import sbild.model.impl.ElectroTypeModelImpl;
 ...
 * @generated
 */
@Component(service = {ElectroTypePersistence.class, BasePersistence.class})
public class ElectroTypePersistenceImpl
	...
	public ElectroTypePersistenceImpl() {
		...
		setTable(ElectroTypeTable.INSTANCE);
	}
	...
	public void clearCache() {
		...
		finderCache.clearCache(ElectroTypeImpl.class);
	}
	 ...
	 */
	@Override
	public ElectroType create(long etypeId) {
		ElectroType electroType = new ElectroTypeImpl();

		electroType.setNew(true);
		electroType.setPrimaryKey(etypeId);
	 ...
	 */
	@Override
	public ElectroType remove(long etypeId) throws NoSuchElectroTypeException {
		return remove((Serializable)etypeId);
	}
	 ...
	 */
	@Override
	public ElectroType findByPrimaryKey(long etypeId)
		throws NoSuchElectroTypeException {

		return findByPrimaryKey((Serializable)etypeId);
	}
	 ...
	 */
	@Override
	public ElectroType fetchByPrimaryKey(long etypeId) {
		return fetchByPrimaryKey((Serializable)etypeId);
	}
	...
	private static class ElectroTypeModelArgumentsResolver
		...
		public String getClassName() {
			return ElectroTypeImpl.class.getName();
		}

		@Override
		public String getTableName() {
			return ElectroTypeTable.INSTANCE.getTableName();
		}
