...
import sbild.model.EmployeeTable;
import sbild.model.impl.EmployeeImpl;
import sbild.model.impl.EmployeeModelImpl;
...
public class EmployeePersistenceImpl
	 ...
	 */
	@Override
	public Employee remove(long emplId) throws NoSuchEmployeeException {
		return remove((Serializable)emplId);
	}
	...
	public Employee findByPrimaryKey(long emplId)
		...
		return findByPrimaryKey((Serializable)emplId);
	}
	 ...
	 */
	@Override
	public Employee fetchByPrimaryKey(long emplId) {
		return fetchByPrimaryKey((Serializable)emplId);
	}
