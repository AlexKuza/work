...
import sbild.exception.NoSuchPositionTypeException;

import sbild.model.PositionType;
import sbild.model.PositionTypeTable;
import sbild.model.impl.PositionTypeImpl;
import sbild.model.impl.PositionTypeModelImpl;
 ...
 * @generated
 */
@Component(service = {PositionTypePersistence.class, BasePersistence.class})
public class PositionTypePersistenceImpl
	...
	public PositionTypePersistenceImpl() {
		...
		setTable(PositionTypeTable.INSTANCE);
	}
	...
	public void clearCache() {
		...
		finderCache.clearCache(PositionTypeImpl.class);
	}
	 ...
	 */
	@Override
	public PositionType remove(long posId) throws NoSuchPositionTypeException {
		return remove((Serializable)posId);
	}
	 ...
	 */
	@Override
	public PositionType findByPrimaryKey(long posId)
		throws NoSuchPositionTypeException {

		return findByPrimaryKey((Serializable)posId);
	}
	 ...
	 */
	@Override
	public PositionType fetchByPrimaryKey(long posId) {
		return fetchByPrimaryKey((Serializable)posId);
	}
	...
	private static class PositionTypeModelArgumentsResolver
		...
		public String getClassName() {
			return PositionTypeImpl.class.getName();
		}

		@Override
		public String getTableName() {
			return PositionTypeTable.INSTANCE.getTableName();
		}
