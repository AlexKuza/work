...
package services.service.persistence.test;
...
import services.exception.NoSuchGuestbookException;

import services.model.Guestbook;

import services.service.GuestbookLocalServiceUtil;
import services.service.persistence.GuestbookPersistence;
import services.service.persistence.GuestbookUtil;
...
public class GuestbookPersistenceTest {
	...
	public static final AggregateTestRule aggregateTestRule =
		new AggregateTestRule(
			...
			new TransactionalTestRule(
				Propagation.REQUIRED, "services.service"));
	...
	protected OrderByComparator<Guestbook> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"AB_Guestbook", "uuid", true, "guestbookId", true, "groupId", true,
