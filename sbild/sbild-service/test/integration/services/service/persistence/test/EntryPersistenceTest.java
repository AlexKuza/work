...
import services.exception.NoSuchEntryException;

import services.model.Entry;

import services.service.EntryLocalServiceUtil;
import services.service.persistence.EntryPersistence;
import services.service.persistence.EntryUtil;
...
public class EntryPersistenceTest {
	...
	protected OrderByComparator<Entry> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"AB_Entry", "uuid", true, "entryId", true, "groupId", true,
