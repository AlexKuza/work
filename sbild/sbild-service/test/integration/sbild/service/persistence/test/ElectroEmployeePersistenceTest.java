...
import sbild.exception.NoSuchElectroEmployeeException;

import sbild.model.ElectroEmployee;

import sbild.service.ElectroEmployeeLocalServiceUtil;
import sbild.service.persistence.ElectroEmployeePK;
import sbild.service.persistence.ElectroEmployeePersistence;
import sbild.service.persistence.ElectroEmployeeUtil;
...
public class ElectroEmployeePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		Assert.assertEquals(
			existingElectroEmployee.getEmplId(),
			newElectroEmployee.getEmplId());
		Assert.assertEquals(
	...
	public void testDynamicQueryByPrimaryKeyExisting() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq(
				"id.emplId", newElectroEmployee.getEmplId()));
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq(
	...
	public void testDynamicQueryByPrimaryKeyMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq("id.emplId", RandomTestUtil.nextLong()));
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq(
	...
	public void testDynamicQueryByProjectionExisting() throws Exception {
		...
		dynamicQuery.setProjection(ProjectionFactoryUtil.property("id.emplId"));

		Object newEmplId = newElectroEmployee.getEmplId();

		dynamicQuery.add(
			RestrictionsFactoryUtil.in("id.emplId", new Object[] {newEmplId}));
	...
	public void testDynamicQueryByProjectionMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.in(
				"id.emplId", new Object[] {RandomTestUtil.nextLong()}));
