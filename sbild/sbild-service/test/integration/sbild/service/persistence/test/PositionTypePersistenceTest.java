...
import sbild.service.PositionTypeLocalServiceUtil;
import sbild.service.persistence.PositionTypePersistence;
import sbild.service.persistence.PositionTypeUtil;
...
public class PositionTypePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		Assert.assertEquals(
			existingPositionType.getPosId(), newPositionType.getPosId());
		Assert.assertEquals(
	...
	protected OrderByComparator<PositionType> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"GB_PositionType", "posId", true, "name", true);
	}
	...
	public void testDynamicQueryByPrimaryKeyExisting() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq("posId", newPositionType.getPosId()));
	...
	public void testDynamicQueryByPrimaryKeyMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq("posId", RandomTestUtil.nextLong()));
	...
	public void testDynamicQueryByProjectionExisting() throws Exception {
		...
		dynamicQuery.setProjection(ProjectionFactoryUtil.property("posId"));

		Object newPosId = newPositionType.getPosId();

		dynamicQuery.add(
			RestrictionsFactoryUtil.in("posId", new Object[] {newPosId}));

		List<Object> result = _persistence.findWithDynamicQuery(dynamicQuery);

		Assert.assertEquals(1, result.size());

		Object existingPosId = result.get(0);

		Assert.assertEquals(existingPosId, newPosId);
	}
	...
	public void testDynamicQueryByProjectionMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.in(
				"posId", new Object[] {RandomTestUtil.nextLong()}));
