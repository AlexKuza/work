...
import sbild.service.ElectroTypeLocalServiceUtil;
import sbild.service.persistence.ElectroTypePersistence;
import sbild.service.persistence.ElectroTypeUtil;
...
public class ElectroTypePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		Assert.assertEquals(
			existingElectroType.getEtypeId(), newElectroType.getEtypeId());
		Assert.assertEquals(
	...
	protected OrderByComparator<ElectroType> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"GB_ElectroType", "etypeId", true, "name", true);
	}
	...
	public void testDynamicQueryByPrimaryKeyExisting() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq("etypeId", newElectroType.getEtypeId()));
	...
	public void testDynamicQueryByPrimaryKeyMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq("etypeId", RandomTestUtil.nextLong()));
	...
	public void testDynamicQueryByProjectionExisting() throws Exception {
		...
		dynamicQuery.setProjection(ProjectionFactoryUtil.property("etypeId"));

		Object newEtypeId = newElectroType.getEtypeId();

		dynamicQuery.add(
			RestrictionsFactoryUtil.in("etypeId", new Object[] {newEtypeId}));

		List<Object> result = _persistence.findWithDynamicQuery(dynamicQuery);

		Assert.assertEquals(1, result.size());

		Object existingEtypeId = result.get(0);

		Assert.assertEquals(existingEtypeId, newEtypeId);
	}
	...
	public void testDynamicQueryByProjectionMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.in(
				"etypeId", new Object[] {RandomTestUtil.nextLong()}));
