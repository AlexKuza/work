...
import sbild.service.persistence.PurchaseTypeUtil;
...
public class PurchaseTypePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		Assert.assertEquals(
			existingPurchaseType.getPurchtypeId(),
			newPurchaseType.getPurchtypeId());
		Assert.assertEquals(
	...
	protected OrderByComparator<PurchaseType> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"GB_PurchaseType", "purchtypeId", true, "name", true);
	}
	...
	public void testDynamicQueryByPrimaryKeyExisting() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq(
				"purchtypeId", newPurchaseType.getPurchtypeId()));
	...
	public void testDynamicQueryByPrimaryKeyMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq(
				"purchtypeId", RandomTestUtil.nextLong()));
	...
	public void testDynamicQueryByProjectionExisting() throws Exception {
		...
		dynamicQuery.setProjection(
			ProjectionFactoryUtil.property("purchtypeId"));

		Object newPurchtypeId = newPurchaseType.getPurchtypeId();

		dynamicQuery.add(
			RestrictionsFactoryUtil.in(
				"purchtypeId", new Object[] {newPurchtypeId}));

		List<Object> result = _persistence.findWithDynamicQuery(dynamicQuery);

		Assert.assertEquals(1, result.size());

		Object existingPurchtypeId = result.get(0);

		Assert.assertEquals(existingPurchtypeId, newPurchtypeId);
	}
	...
	public void testDynamicQueryByProjectionMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.in(
				"purchtypeId", new Object[] {RandomTestUtil.nextLong()}));
