...
import sbild.service.PurchaseLocalServiceUtil;
import sbild.service.persistence.PurchasePersistence;
import sbild.service.persistence.PurchaseUtil;
...
public class PurchasePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newPurchase.setElectrId(RandomTestUtil.nextLong());

		newPurchase.setEmplId(RandomTestUtil.nextLong());

		newPurchase.setPurchDate(RandomTestUtil.nextDate());

		newPurchase.setPurchtypeId(RandomTestUtil.nextLong());
		...
		Assert.assertEquals(
			existingPurchase.getPurchId(), newPurchase.getPurchId());
		Assert.assertEquals(
			existingPurchase.getElectrId(), newPurchase.getElectrId());
		Assert.assertEquals(
			existingPurchase.getEmplId(), newPurchase.getEmplId());
		Assert.assertEquals(
			Time.getShortTimestamp(existingPurchase.getPurchDate()),
			Time.getShortTimestamp(newPurchase.getPurchDate()));
		Assert.assertEquals(
			existingPurchase.getPurchtypeId(), newPurchase.getPurchtypeId());
	}
	...
	protected OrderByComparator<Purchase> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"GB_Purchase", "purchId", true, "electrId", true, "emplId", true,
			"purchDate", true, "purchtypeId", true);
	}
	...
	public void testDynamicQueryByPrimaryKeyExisting() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq("purchId", newPurchase.getPurchId()));
	...
	public void testDynamicQueryByPrimaryKeyMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq("purchId", RandomTestUtil.nextLong()));
	...
	public void testDynamicQueryByProjectionExisting() throws Exception {
		...
		dynamicQuery.setProjection(ProjectionFactoryUtil.property("purchId"));

		Object newPurchId = newPurchase.getPurchId();

		dynamicQuery.add(
			RestrictionsFactoryUtil.in("purchId", new Object[] {newPurchId}));

		List<Object> result = _persistence.findWithDynamicQuery(dynamicQuery);

		Assert.assertEquals(1, result.size());

		Object existingPurchId = result.get(0);

		Assert.assertEquals(existingPurchId, newPurchId);
	}
	...
	public void testDynamicQueryByProjectionMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.in(
				"purchId", new Object[] {RandomTestUtil.nextLong()}));
	...
	protected Purchase addPurchase() throws Exception {
		...
		purchase.setElectrId(RandomTestUtil.nextLong());

		purchase.setEmplId(RandomTestUtil.nextLong());

		purchase.setPurchDate(RandomTestUtil.nextDate());

		purchase.setPurchtypeId(RandomTestUtil.nextLong());
