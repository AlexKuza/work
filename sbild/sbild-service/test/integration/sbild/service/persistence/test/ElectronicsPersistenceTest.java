...
import sbild.service.ElectronicsLocalServiceUtil;
import sbild.service.persistence.ElectronicsPersistence;
import sbild.service.persistence.ElectronicsUtil;
...
public class ElectronicsPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		Assert.assertEquals(
			existingElectronics.getElectrId(), newElectronics.getElectrId());
		Assert.assertEquals(
	...
	protected OrderByComparator<Electronics> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"GB_Electronics", "electrId", true, "name", true, "etypeId", true,
			"price", true, "count", true, "inStock", true, "archive", true,
			"description", true);
	}
	...
	public void testDynamicQueryByPrimaryKeyExisting() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq(
				"electrId", newElectronics.getElectrId()));
	...
	public void testDynamicQueryByPrimaryKeyMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq("electrId", RandomTestUtil.nextLong()));
	...
	public void testDynamicQueryByProjectionExisting() throws Exception {
		...
		dynamicQuery.setProjection(ProjectionFactoryUtil.property("electrId"));

		Object newElectrId = newElectronics.getElectrId();

		dynamicQuery.add(
			RestrictionsFactoryUtil.in("electrId", new Object[] {newElectrId}));

		List<Object> result = _persistence.findWithDynamicQuery(dynamicQuery);

		Assert.assertEquals(1, result.size());

		Object existingElectrId = result.get(0);

		Assert.assertEquals(existingElectrId, newElectrId);
	}
	...
	public void testDynamicQueryByProjectionMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.in(
				"electrId", new Object[] {RandomTestUtil.nextLong()}));
