...
import sbild.exception.NoSuchEmployeeException;

import sbild.model.Employee;

import sbild.service.EmployeeLocalServiceUtil;
import sbild.service.persistence.EmployeePersistence;
import sbild.service.persistence.EmployeeUtil;
...
public class EmployeePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newEmployee.setPosId(RandomTestUtil.nextLong());
		...
		Assert.assertEquals(
			existingEmployee.getEmplId(), newEmployee.getEmplId());
		Assert.assertEquals(
		...
		Assert.assertEquals(
			existingEmployee.getPosId(), newEmployee.getPosId());
		Assert.assertEquals(
	...
	protected OrderByComparator<Employee> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"GB_Employee", "emplId", true, "lastname", true, "firstname", true,
			"patronymic", true, "birthdate", true, "posId", true, "gender",
			true);
	}
	...
	public void testDynamicQueryByPrimaryKeyExisting() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq("emplId", newEmployee.getEmplId()));
	...
	public void testDynamicQueryByPrimaryKeyMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq("emplId", RandomTestUtil.nextLong()));
	...
	public void testDynamicQueryByProjectionExisting() throws Exception {
		...
		dynamicQuery.setProjection(ProjectionFactoryUtil.property("emplId"));

		Object newEmplId = newEmployee.getEmplId();

		dynamicQuery.add(
			RestrictionsFactoryUtil.in("emplId", new Object[] {newEmplId}));

		List<Object> result = _persistence.findWithDynamicQuery(dynamicQuery);

		Assert.assertEquals(1, result.size());

		Object existingEmplId = result.get(0);

		Assert.assertEquals(existingEmplId, newEmplId);
	}
	...
	public void testDynamicQueryByProjectionMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.in(
				"emplId", new Object[] {RandomTestUtil.nextLong()}));
	...
	protected Employee addEmployee() throws Exception {
		...
		employee.setPosId(RandomTestUtil.nextLong());
