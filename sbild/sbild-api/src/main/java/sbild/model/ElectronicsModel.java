...
/**
 * The base model interface for the Electronics service. Represents a row in the &quot;GB_Electronics&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>sbild.model.impl.ElectronicsModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>sbild.model.impl.ElectronicsImpl</code>.
 * </p>
 *
 * @author liferay
 * @see Electronics
