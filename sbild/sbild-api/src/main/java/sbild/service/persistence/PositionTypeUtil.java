...
/**
 * The persistence utility for the position type service. This utility wraps <code>sbild.service.persistence.impl.PositionTypePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class PositionTypeUtil {
	 ...
	 */
	public static PositionType create(long posId) {
		return getPersistence().create(posId);
	}
	 ...
	 */
	public static PositionType remove(long posId)
		throws sbild.exception.NoSuchPositionTypeException {

		return getPersistence().remove(posId);
	}
	 ...
	 * @throws NoSuchPositionTypeException if a position type with the primary key could not be found
	 */
	public static PositionType findByPrimaryKey(long posId)
		throws sbild.exception.NoSuchPositionTypeException {

		return getPersistence().findByPrimaryKey(posId);
	}
	 ...
	 */
	public static PositionType fetchByPrimaryKey(long posId) {
		return getPersistence().fetchByPrimaryKey(posId);
	}
	...
	private static ServiceTracker
		<PositionTypePersistence, PositionTypePersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(PositionTypePersistence.class);

		ServiceTracker<PositionTypePersistence, PositionTypePersistence>
			serviceTracker =
				new ServiceTracker
					<PositionTypePersistence, PositionTypePersistence>(
						bundle.getBundleContext(),
						PositionTypePersistence.class, null);
