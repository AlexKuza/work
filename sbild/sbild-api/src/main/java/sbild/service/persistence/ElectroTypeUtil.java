...
public class ElectroTypeUtil {
	 ...
	 */
	public static ElectroType create(long etypeId) {
		return getPersistence().create(etypeId);
	}
	 ...
	 */
	public static ElectroType remove(long etypeId)
		throws sbild.exception.NoSuchElectroTypeException {

		return getPersistence().remove(etypeId);
	}
	 ...
	 * @throws NoSuchElectroTypeException if a electro type with the primary key could not be found
	 */
	public static ElectroType findByPrimaryKey(long etypeId)
		throws sbild.exception.NoSuchElectroTypeException {

		return getPersistence().findByPrimaryKey(etypeId);
	}
	 ...
	 */
	public static ElectroType fetchByPrimaryKey(long etypeId) {
		return getPersistence().fetchByPrimaryKey(etypeId);
	}
	...
	private static ServiceTracker
		<ElectroTypePersistence, ElectroTypePersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(ElectroTypePersistence.class);

		ServiceTracker<ElectroTypePersistence, ElectroTypePersistence>
			serviceTracker =
				new ServiceTracker
					<ElectroTypePersistence, ElectroTypePersistence>(
						bundle.getBundleContext(), ElectroTypePersistence.class,
						null);
