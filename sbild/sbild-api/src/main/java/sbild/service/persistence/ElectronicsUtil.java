...
/**
 * The persistence utility for the electronics service. This utility wraps <code>sbild.service.persistence.impl.ElectronicsPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ElectronicsUtil {
	 ...
	 */
	public static Electronics create(long electrId) {
		return getPersistence().create(electrId);
	}
	 ...
	 */
	public static Electronics remove(long electrId)
		throws sbild.exception.NoSuchElectronicsException {

		return getPersistence().remove(electrId);
	}
	 ...
	 * @throws NoSuchElectronicsException if a electronics with the primary key could not be found
	 */
	public static Electronics findByPrimaryKey(long electrId)
		throws sbild.exception.NoSuchElectronicsException {

		return getPersistence().findByPrimaryKey(electrId);
	}
	 ...
	 */
	public static Electronics fetchByPrimaryKey(long electrId) {
		return getPersistence().fetchByPrimaryKey(electrId);
	}
