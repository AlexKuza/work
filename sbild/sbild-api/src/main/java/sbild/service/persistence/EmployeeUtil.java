...
public class EmployeeUtil {
	 ...
	 */
	public static Employee create(long emplId) {
	 ...
	 */
	public static Employee remove(long emplId)
		throws sbild.exception.NoSuchEmployeeException {
	 ...
	 * @throws NoSuchEmployeeException if a employee with the primary key could not be found
	 */
	public static Employee findByPrimaryKey(long emplId)
		throws sbild.exception.NoSuchEmployeeException {
	 ...
	 */
	public static Employee fetchByPrimaryKey(long emplId) {
