...
public class PurchaseUtil {
	 ...
	 */
	public static Purchase create(long purchId) {
		return getPersistence().create(purchId);
	}
	 ...
	 */
	public static Purchase remove(long purchId)
		throws sbild.exception.NoSuchPurchaseException {

		return getPersistence().remove(purchId);
	}
	 ...
	 * @throws NoSuchPurchaseException if a purchase with the primary key could not be found
	 */
	public static Purchase findByPrimaryKey(long purchId)
		throws sbild.exception.NoSuchPurchaseException {

		return getPersistence().findByPrimaryKey(purchId);
	}
	 ...
	 */
	public static Purchase fetchByPrimaryKey(long purchId) {
		return getPersistence().fetchByPrimaryKey(purchId);
	}
