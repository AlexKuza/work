...
public class ElectroEmployeeUtil {
	...
	public static ElectroEmployee remove(
			sbild.service.persistence.ElectroEmployeePK electroEmployeePK)
		throws sbild.exception.NoSuchElectroEmployeeException {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			ElectroEmployeePersistence.class);

		ServiceTracker<ElectroEmployeePersistence, ElectroEmployeePersistence>
			serviceTracker =
				new ServiceTracker
					<ElectroEmployeePersistence, ElectroEmployeePersistence>(
						bundle.getBundleContext(),
						ElectroEmployeePersistence.class, null);
