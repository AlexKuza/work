...
public class PurchaseTypeUtil {
	 ...
	 */
	public static PurchaseType create(long purchtypeId) {
		return getPersistence().create(purchtypeId);
	}
	 ...
	 */
	public static PurchaseType remove(long purchtypeId)
		throws sbild.exception.NoSuchPurchaseTypeException {

		return getPersistence().remove(purchtypeId);
	}
	 ...
	 * @throws NoSuchPurchaseTypeException if a purchase type with the primary key could not be found
	 */
	public static PurchaseType findByPrimaryKey(long purchtypeId)
		throws sbild.exception.NoSuchPurchaseTypeException {

		return getPersistence().findByPrimaryKey(purchtypeId);
	}
	 ...
	 */
	public static PurchaseType fetchByPrimaryKey(long purchtypeId) {
		return getPersistence().fetchByPrimaryKey(purchtypeId);
	}
