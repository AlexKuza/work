 ...
 * <code>sbild.service.impl.EmployeeLocalServiceImpl</code> and
...
public class EmployeeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>sbild.service.impl.EmployeeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Employee createEmployee(long emplId) {
	 ...
	 */
	public static Employee deleteEmployee(long emplId) throws PortalException {
		return getService().deleteEmployee(emplId);
	}

	public static void deleteEmployees() {
		getService().deleteEmployees();
	}
	...
	public static Employee fetchEmployee(long emplId) {
	 ...
	 * @throws PortalException if a employee with the primary key could not be found
	 */
	public static Employee getEmployee(long emplId) throws PortalException {
