...
public interface ElectronicsLocalService
	...
	public Electronics createElectronics(long electrId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Electronics fetchElectronics(long electrId);
