 ...
 * <code>sbild.service.impl.ElectroTypeLocalServiceImpl</code> and
...
public class ElectroTypeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>sbild.service.impl.ElectroTypeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static ElectroType addElectroType(long etypeId, String name)
		throws PortalException {

		return getService().addElectroType(etypeId, name);
	}
	 ...
	 */
	public static ElectroType createElectroType(long etypeId) {
		return getService().createElectroType(etypeId);
	}
	 ...
	 */
	public static ElectroType deleteElectroType(long etypeId)
		throws PortalException {

		return getService().deleteElectroType(etypeId);
	}

	public static void deleteElectroTypes() {
		getService().deleteElectroTypes();
	}
	...
	public static ElectroType fetchElectroType(long etypeId) {
		return getService().fetchElectroType(etypeId);
	}
	 ...
	 * @throws PortalException if a electro type with the primary key could not be found
	 */
	public static ElectroType getElectroType(long etypeId)
		throws PortalException {

		return getService().getElectroType(etypeId);
	}
