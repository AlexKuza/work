...
public class ElectroTypeLocalServiceWrapper
	 ...
	 */
	@Override
	public sbild.model.ElectroType addElectroType(
		sbild.model.ElectroType electroType) {

		return _electroTypeLocalService.addElectroType(electroType);
	}

	@Override
	public sbild.model.ElectroType addElectroType(long etypeId, String name)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _electroTypeLocalService.addElectroType(etypeId, name);
	}

	/**
	 * Creates a new electro type with the primary key. Does not add the electro type to the database.
	 *
	 * @param etypeId the primary key for the new electro type
	 * @return the new electro type
	 */
	@Override
	public sbild.model.ElectroType createElectroType(long etypeId) {
		return _electroTypeLocalService.createElectroType(etypeId);
	}
	 ...
	 */
	@Override
	public sbild.model.ElectroType deleteElectroType(
		sbild.model.ElectroType electroType) {
	 ...
	 * </p>
	 *
	 * @param etypeId the primary key of the electro type
	 * @return the electro type that was removed
	 * @throws PortalException if a electro type with the primary key could not be found
	 */
	@Override
	public sbild.model.ElectroType deleteElectroType(long etypeId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _electroTypeLocalService.deleteElectroType(etypeId);
	}
	...
	public <T> T dslQuery(com.liferay.petra.sql.dsl.query.DSLQuery dslQuery) {
		return _electroTypeLocalService.dslQuery(dslQuery);
	}
	...
	public int dslQueryCount(
		...
		return _electroTypeLocalService.dslQueryCount(dslQuery);
	}
	...
	@Override
	public sbild.model.ElectroType fetchElectroType(long etypeId) {
		return _electroTypeLocalService.fetchElectroType(etypeId);
	}
	 ...
	 */
	@Override
	public sbild.model.ElectroType getElectroType(long etypeId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _electroTypeLocalService.getElectroType(etypeId);
	}
	 ...
	 */
	@Override
	public java.util.List<sbild.model.ElectroType> getElectroTypes(
		int start, int end) {
	 ...
	 */
	@Override
	public sbild.model.ElectroType updateElectroType(
		sbild.model.ElectroType electroType) {
