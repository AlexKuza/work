 ...
 * <code>sbild.service.impl.PurchaseTypeLocalServiceImpl</code> and
...
public class PurchaseTypeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>sbild.service.impl.PurchaseTypeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static PurchaseType addPurchaseType(long ptypeId, String name)
		throws PortalException {

		return getService().addPurchaseType(ptypeId, name);
	}
	 ...
	 */
	public static PurchaseType createPurchaseType(long purchtypeId) {
		return getService().createPurchaseType(purchtypeId);
	}
	 ...
	 */
	public static PurchaseType deletePurchaseType(long purchtypeId)
		throws PortalException {

		return getService().deletePurchaseType(purchtypeId);
	}
	...
	public static void deletePurchaseTypes() {
		getService().deletePurchaseTypes();
	}
	...
	public static PurchaseType fetchPurchaseType(long purchtypeId) {
		return getService().fetchPurchaseType(purchtypeId);
	}
	 ...
	 * @throws PortalException if a purchase type with the primary key could not be found
	 */
	public static PurchaseType getPurchaseType(long purchtypeId)
		throws PortalException {

		return getService().getPurchaseType(purchtypeId);
	}
