 ...
 * <code>sbild.service.impl.PositionTypeLocalServiceImpl</code> and
...
public class PositionTypeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>sbild.service.impl.PositionTypeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static PositionType addPositionType(long posId, String name)
		throws PortalException {

		return getService().addPositionType(posId, name);
	}
	 ...
	 */
	public static PositionType createPositionType(long posId) {
		return getService().createPositionType(posId);
	}
	 ...
	 */
	public static PositionType deletePositionType(long posId)
		throws PortalException {

		return getService().deletePositionType(posId);
	}
	...
	public static void deletePositionTypes() {
		getService().deletePositionTypes();
	}
	...
	public static PositionType fetchPositionType(long posId) {
		return getService().fetchPositionType(posId);
	}
	 ...
	 * @throws PortalException if a position type with the primary key could not be found
	 */
	public static PositionType getPositionType(long posId)
		throws PortalException {

		return getService().getPositionType(posId);
	}
