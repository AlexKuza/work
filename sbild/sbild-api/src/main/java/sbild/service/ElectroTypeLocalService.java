...
public interface ElectroTypeLocalService
	...
	public ElectroType createElectroType(long etypeId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ElectroType deleteElectroType(long etypeId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ElectroType fetchElectroType(long etypeId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ElectroType getElectroType(long etypeId) throws PortalException;
