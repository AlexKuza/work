 ...
 * <code>sbild.service.impl.PurchaseLocalServiceImpl</code> and
...
public class PurchaseLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>sbild.service.impl.PurchaseLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Purchase createPurchase(long purchId) {
		return getService().createPurchase(purchId);
	}
	 ...
	 */
	public static Purchase deletePurchase(long purchId) throws PortalException {
		return getService().deletePurchase(purchId);
	}
	...
	public static Purchase fetchPurchase(long purchId) {
		return getService().fetchPurchase(purchId);
	}
	 ...
	 * @throws PortalException if a purchase with the primary key could not be found
	 */
	public static Purchase getPurchase(long purchId) throws PortalException {
		return getService().getPurchase(purchId);
	}
