...
public interface EmployeeLocalService
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Employee deleteEmployee(long emplId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Employee fetchEmployee(long emplId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Employee getEmployee(long emplId) throws PortalException;
