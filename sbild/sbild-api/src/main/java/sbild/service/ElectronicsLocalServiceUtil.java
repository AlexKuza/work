 ...
 * <code>sbild.service.impl.ElectronicsLocalServiceImpl</code> and
...
public class ElectronicsLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>sbild.service.impl.ElectronicsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Electronics createElectronics(long electrId) {
		return getService().createElectronics(electrId);
	}
	 ...
	 */
	public static Electronics deleteElectronics(long electrId)
		throws PortalException {

		return getService().deleteElectronics(electrId);
	}
	...
	public static Electronics fetchElectronics(long electrId) {
		return getService().fetchElectronics(electrId);
	}
	 ...
	 * @throws PortalException if a electronics with the primary key could not be found
	 */
	public static Electronics getElectronics(long electrId)
		throws PortalException {

		return getService().getElectronics(electrId);
	}
