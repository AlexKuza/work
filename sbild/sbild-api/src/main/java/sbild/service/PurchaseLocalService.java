...
public interface PurchaseLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>sbild.service.impl.PurchaseLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the purchase local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PurchaseLocalServiceUtil} if injection and service tracking are not available.
	 */
	public Purchase addPurchase(
			long purchId, long electrId, long emplId, Date purchDate,
			long purchtypeId)
	...
	public Purchase createPurchase(long purchId);
	...
	public Purchase deletePurchase(long purchId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Purchase fetchPurchase(long purchId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Purchase getPurchase(long purchId) throws PortalException;
